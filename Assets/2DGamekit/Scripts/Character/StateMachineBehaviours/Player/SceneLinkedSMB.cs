...
namespace Gamekit2D
{
        ...
        where TMonoBehaviour : MonoBehaviour
    {
        ...
        public sealed override void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex, AnimatorControllerPlayable controller)
        {
            ...
            Debug.Log("animator enter    " + stateInfo.fullPathHash + "  " + m_FirstFrameHappened + "  " + m_LastFrameHappened);
        ...
        {
            Debug.Log("animator update    " + stateInfo.fullPathHash + "   " + animator.GetNextAnimatorStateInfo(layerIndex).fullPathHash + animator.IsInTransition(layerIndex));
        ...
        public sealed override void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex, AnimatorControllerPlayable controller)
        {
            ...
            Debug.Log("animator exit    " + stateInfo.fullPathHash);
